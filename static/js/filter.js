...
document.addEventListener("DOMContentLoaded", function() {
  ...
  document.querySelector('#keyword_add').addEventListener('click', function(e) {
    var keyword_list = document.querySelector('#keyword_list');
    var keyword_list_items = document.querySelector('#keyword_list').getElementsByTagName('li');
    ...
    if (keyword_toadd.length > 0) {
      ...
      keyword_delete.addEventListener('click', function(evt) {
        ...
        if (keyword_list_items[keyword_list_items.length - 1].getAttribute('class') == 'keyword_and_or_container') {
          keyword_list_items[keyword_list_items.length - 1].remove();
        }
      });
